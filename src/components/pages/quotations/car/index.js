                ...
                <div className={classes.bg}>
                    <div className="container padding">
                        ...
                        <div style={{ marginTop: 30 }}>
                            <Message type={error ? 'error' : 'success'} title="Cotação - Carro" heading="Formulário enviado com sucesso!" subheading="Formulário enviado com sucesso! Em até 24 h entraremos em contato com as melhores soluções para sua experiência" />
                        </div>
                    </div>
                </div>
            );
